...
class AuthController extends Controller
{
    ...
    //         'company_id' => 'required',
    //         'payment_per_hour' => 'nullable|string',
    ...
    //         'payment'=> $fields['payment_per_hour'],
    ...
    public function register(Request $request)
{
    ...
    $user = User::create([
        'name'       => $fields['name'],
        'email'      => $request->input('email', null), // ✅ handles missing key safely
        'mobile'     => $fields['mobile'],
        'type'       => $fields['type'],
        'company_id' => $fields['company_id'],
        'payment'    => $request->input('payment_per_hour', null), // ✅ defaults to null if not sent
        'address'    => $request->input('address', null),          // ✅ also safe
        'password'   => bcrypt($fields['password']),
    ]);
...
public function userUpdated(Request $request)
{
    ...
    $user->update([
        ...
        'company_id' => $request->company_id, 
        'blocked'    => $request->blocked,
        'payment'    => $request->input('payment_per_hour', $user->payment), // Update payment if provided, else keep existing
