...
const EditCustomer = () => {
  ...
  useEffect(()=>{
    try {
      loadCustomerData();
      getAPICall('/api/companies').then((resp) => {
    ...
    <CRow>
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong><b>Edit Customer Details</b></strong>
          </CCardHeader>
          <CCardBody>
            <CForm className="needs-validation" noValidate onSubmit={handleSubmit}>
              <div className="mb-3">
                <CFormLabel htmlFor="pname"><b>Customer Name</b></CFormLabel>
                <CFormInput
                  type="text"
                  id="pname"
              ...
              <div className="mb-3">
                <CFormLabel htmlFor="plmobile"><b>Mobile Number</b></CFormLabel>
                <CFormInput
                  type="text"
                  id="plmobile"
              ...
              <div className="mb-3">
                <CFormLabel htmlFor="categoryId"><b>Company </b></CFormLabel>
                <CFormSelect
              ...
              <div className="mb-3">
                <CFormLabel htmlFor="address"><b>Address</b></CFormLabel>
                <CFormTextarea
                  id="address"
                  rows={2}
                  name="address"
