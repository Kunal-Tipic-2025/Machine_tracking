...
//   const units = ["kg", "pcs", "mg", "ltr", "bag"]; // Available units
...
//       const stock = parseFloat(name === "current_stock" ? value : updatedData.current_stock) || 0;
//       const price = parseFloat(name === "price" ? value : updatedData.price) || 0;
